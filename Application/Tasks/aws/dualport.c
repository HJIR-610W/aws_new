...
void check_sensor_use(void)
{
  ...
  g_kma_inst_ex.wind_direction_instant.enable = g_p_raw->data[A4_INSTANT_WIND_DIRECTION].enable;
  g_kma_inst_ex.wind_speed_instant.enable = g_p_raw->data[A5_INSTANT_WIND_SPEED].enable;
