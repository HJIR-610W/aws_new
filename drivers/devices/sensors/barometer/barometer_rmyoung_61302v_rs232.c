...
typedef struct rmyoung_61302v_rs232_instance_s
{
    ...
    void *sem;
    bool opened;
} rmyoung_61302v_rs232_instance_t;

rmyoung_61302v_rs232_instance_t rmyoung_61302v_rs232_inst;
...
{
    barometer_rmyoung_61302v_rs232_config_t *cfg = (barometer_rmyoung_61302v_rs232_config_t *)opt;
    uart_config_t uart_config;

    if (rmyoung_61302v_rs232_inst.opened)
    {
        return 1;
    }

    rmyoung_61302v_rs232_inst.opened = true;
    uart_config.baud = 9600;
    uart_config.dataLen = UART_DATA_LEN_8;
    uart_config.parity_index = PARITY_NONE;
    uart_config.stop_bit = UART_STOP_BIT_1;

    rmyoung_61302v_rs232_inst.rs232_port = uart_num_to_driver_num(cfg->rs232_port);
    drv_uart_init(rmyoung_61302v_rs232_inst.rs232_port, &uart_config,"Pressure");

    OS_CREATE_BINARY_SEM(rmyoung_61302v_rs232_inst.sem);
