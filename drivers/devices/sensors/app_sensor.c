...
const uint8_t pressure_list[] = {S_T_UNSUED, S_T_BARO_RMYOUNG_61302V, S_T_BARO_JINSUNG_SJGP215,S_T_BARO_RMYOUNG_61302V_RS232, S_T_ADC};
  ...
  switch(type)
  {
    ...
    case A7_PRESSURE:
      switch(model)
      {
        ...
        return &g_config_sensor.baromater.rmyoung_61302v_barometer;
        case S_T_BARO_RMYOUNG_61302V_RS232:
        return &g_config_sensor.baromater.rmyoung_61302v_rs232;
        case S_T_ADC:
