...
cnt					+= 5;
sprintf(&framemk[cnt],"%4d", (int)(g_rainfall.yearly/10.0));					// 연간 누계 강우량
cnt					+= 4;
sprintf(&framemk[cnt], "%4d", (int)(g_rainfall.today / 10.0)); // 금일  강우량
cnt					+= 4;
sprintf(&framemk[cnt], "%4d", (int)(g_rainfall.yesterday / 10.0)); // 전일  강우량
cnt					+= 4;
