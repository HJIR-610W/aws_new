        ...
        if (model)  // 모델이 존재하면 사용함을 의미
        {
          ...
          switch (sensor_type)
          {
            case A1_TEMPERATURE:
              ...
              pa_reading_1s[A1_TEMPERATURE].data.f = adc;
            ...
            case A7_PRESSURE:
              ...
              pa_reading_1s[A7_PRESSURE].data.f = adc;
            ...
            case A10_RELATIVE_HUMIDITY:
              ...
              pa_reading_1s[A10_RELATIVE_HUMIDITY].data.f = adc;
            ...
            case B5_SOIL_TEMPERATURE_5CM:
              ...
              pa_reading_1s[B5_SOIL_TEMPERATURE_5CM].data.f = fData;
            ...
            case B6_SOIL_TEMPERATURE_10CM:
              ...
              pa_reading_1s[B6_SOIL_TEMPERATURE_10CM].data.f = fData;
            ...
            case B7_SOIL_TEMPERATURE_20CM:
              ...
              pa_reading_1s[B7_SOIL_TEMPERATURE_20CM].data.f = fData;
            ...
            case B8_SOIL_TEMPERATURE_30CM:
              ...
              pa_reading_1s[B8_SOIL_TEMPERATURE_30CM].data.f = fData;
            ...
            case B9_SOIL_TEMPERATURE_50CM:
              ...
              pa_reading_1s[B9_SOIL_TEMPERATURE_50CM].data.f = fData;
            ...
            case B10_SOIL_TEMPERATURE_100CM:
              ...
              pa_reading_1s[B10_SOIL_TEMPERATURE_100CM].data.f = fData;
            ...
            case B11_SOIL_TEMPERATURE_150CM:
              ...
              pa_reading_1s[B11_SOIL_TEMPERATURE_150CM].data.f = fData;
            ...
            case B12_SOIL_TEMPERATURE_300CM:
              ...
              pa_reading_1s[B12_SOIL_TEMPERATURE_300CM].data.f = fData;
