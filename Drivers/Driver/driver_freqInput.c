...
void freqMeasureB_init(void)
{
  ...
  htim10.Init.Prescaler = calculate_timer_prescaler(TIM10, 10000);  // 10kHz timer frequency (100us period)
...
void freqMeasureC_init(void)
{
  ...
  htim11.Init.Prescaler = calculate_timer_prescaler(TIM11, 10000);  // 10kHz timer frequency (100us period)
...
uint32_t calculate_timer_prescaler(TIM_TypeDef *tim_instance, uint32_t desired_freq_hz)
{
  ...
  if (tim_instance == TIM10 || tim_instance == TIM11)
  {
