...
/* IRQ 이름 테이블 */
IRQ_Info IRQ_Table[] = {
    {0,  "WWDG"}, {1,  "PVD"}, {2,  "TAMP_STAMP"}, {3,  "RTC_WKUP"}, {4,  "FLASH"},
    {5,  "RCC"}, {6,  "EXTI0"}, {7,  "EXTI1"}, {8,  "EXTI2"}, {9,  "EXTI3"}, {10, "EXTI4"},
    {11, "DMA1_Stream0"}, {12, "DMA1_Stream1"}, {13, "DMA1_Stream2"}, {14, "DMA1_Stream3"},
    {15, "DMA1_Stream4"}, {16, "DMA1_Stream5"}, {17, "DMA1_Stream6"}, {18, "ADC"},
    {19, "CAN1_TX"}, {20, "CAN1_RX0"}, {21, "CAN1_RX1"}, {22, "CAN1_SCE"}, {23, "EXTI9_5"},
    {24, "TIM1_BRK_TIM9"}, {25, "TIM1_UP_TIM10"}, {26, "TIM1_TRG_COM_TIM11"}, {27, "TIM1_CC"},
    {28, "TIM2"}, {29, "TIM3"}, {30, "TIM4"}, {31, "I2C1_EV"}, {32, "I2C1_ER"},
    {33, "I2C2_EV"}, {34, "I2C2_ER"}, {35, "SPI1"}, {36, "SPI2"}, {37, "USART1"},
    {38, "USART2"}, {39, "USART3"}, {40, "EXTI15_10"}, {41, "RTC_Alarm"},
    {42, "OTG_FS_WKUP"}, {43, "TIM8_BRK_TIM12"}, {44, "TIM8_UP_TIM13"},
    {45, "TIM8_TRG_COM_TIM14"}, {46, "TIM8_CC"}, {47, "DMA1_Stream7"}, {48, "FSMC"},
    {49, "SDIO"}, {50, "TIM5"}, {51, "SPI3"}, {52, "UART4"}, {53, "UART5"},
    {54, "TIM6_DAC"}, {55, "TIM7"}, {56, "DMA2_Stream0"}, {57, "DMA2_Stream1"},
    {58, "DMA2_Stream2"}, {59, "DMA2_Stream3"}, {60, "DMA2_Stream4"}, {61, "ETH"},
    {62, "ETH_WKUP"}, {63, "CAN2_TX"}, {64, "CAN2_RX0"}, {65, "CAN2_RX1"},
    {66, "CAN2_SCE"}, {67, "OTG_FS"}, {68, "DMA2_Stream5"}, {69, "DMA2_Stream6"},
    {70, "DMA2_Stream7"}, {71, "USART6"}, {72, "I2C3_EV"}, {73, "I2C3_ER"},
    {74, "OTG_HS_EP1_OUT"}, {75, "OTG_HS_EP1_IN"}, {76, "OTG_HS_WKUP"},
    {77, "OTG_HS"}, {78, "DCMI"}, {79, "CRYP"}, {80, "HASH_RNG"}, {81, "FPU"}
};
...
const char* GetEXTIPortPinMapping(uint8_t exti_line) {
    ...
    switch (port_index) {
        case 0: port_name = "GPIOA"; break;
        case 1: port_name = "GPIOB"; break;
        case 2: port_name = "GPIOC"; break;
        case 3: port_name = "GPIOD"; break;
        case 4: port_name = "GPIOE"; break;
        case 5: port_name = "GPIOF"; break;
        case 6: port_name = "GPIOG"; break;
        case 7: port_name = "GPIOH"; break;
        case 8: port_name = "GPIOI"; break;
...
const char* dma1_mapping[8][8] = {
    {"SPI3_RX",       "I2C1_RX",      "TIM4_CH1",      "I2S3_EXT_RX", "UART5_RX",      "UART8_TX",     "TIM5_CH3", "-"}, // Stream 0
    {"-",             "-",            "-",             "TIM2_UP",     "USART3_RX",     "UART7_TX",     "TIM5_CH4", "-"}, // Stream 1
    {"SPI3_RX",       "TIM7_UP",      "I2S3_EXT_TX",   "I2C3_RX",     "UART4_RX",      "-",            "TIM5_CH1", "-"}, // Stream 2
    {"SPI2_RX",       "-",            "TIM4_CH2",      "I2S3_EXT_RX", "USART3_TX",     "UART4_TX",     "-",        "-"}, // Stream 3
    {"SPI2_TX",       "TIM7_UP",      "I2S2_EXT_TX",   "I2C3_TX",     "UART4_TX",      "-",            "TIM5_CH2", "-"}, // Stream 4
    {"SPI3_TX",       "I2C1_RX",      "I2S3_EXT_TX",   "-",           "USART3_TX",     "DAC1",         "-",        "-"}, // Stream 5
    {"-",             "I2C1_TX",      "TIM4_UP",       "-",           "TIM3_CH1",      "DAC2",         "TIM5_UP",  "-"}, // Stream 6
    {"SPI3_TX",       "I2C1_TX",      "TIM4_CH3",      "TIM2_CH4",    "USART2_RX",     "-",            "-",        "-"}  // Stream 7
};

// DMA2 스트림 요청 매핑 테이블
const char* dma2_mapping[8][8] = {
    {"ADC1",          "-",            "ADC3",          "SPI1_RX",     "SPI4_RX",       "-",            "TIM5_CH3", "-"}, // Stream 0
    {"-",             "DCMI",         "ADC3",          "-",           "-",             "USART6_RX",    "TIM5_CH4", "TIM6_UP"}, // Stream 1
...
void Print_DMA_Stream_Peripherals(char *buff, uint16_t buffSize, uint8_t dmaNum, uint8_t stream) {
    ...
    // DMA 스트림의 채널 선택 확인
    DMA_Stream_TypeDef* dmaStream = (dmaNum == 1) ?
    ...
    switch (irq_num) {
        ...
        case EXTI9_5_IRQn:
           snprintf(buffer, sizeof(buffer), "IMR=%04x,%s",(EXTI->IMR & 0x03E0),
            ...
            break;
        case EXTI15_10_IRQn:
            snprintf(buffer, sizeof(buffer), "IMR=%04x,%s",
                     (EXTI->IMR & 0xFC00),
        ...
        case USART6_IRQn: 
        {
            USART_TypeDef* usart = (irq_num == USART1_IRQn) ? USART1 :
                                   ...
                                   (irq_num == USART3_IRQn) ? USART3 : USART6;
            snprintf(buffer, sizeof(buffer),
                     "TE=%d, RE=%d, IDLEIE=%d, TCIE=%d, RXNEIE=%d",
                     (usart->CR1 & USART_CR1_TE) != 0,
                     (usart->CR1 & USART_CR1_RE) != 0,
        ...
        case SPI3_IRQn: 
        {
            SPI_TypeDef* spi = (irq_num == SPI1_IRQn) ? SPI1 :
                               (irq_num == SPI2_IRQn) ? SPI2 : SPI3;
            snprintf(buffer, sizeof(buffer),
                     "TXEIE=%d, RXNEIE=%d, ERRIE=%d",
...
DMA_PRINT:
        ...
        case TIM5_IRQn: 
        {
            TIM_TypeDef* tim = (irq_num == TIM2_IRQn) ? TIM2 :
                               ...
                               (irq_num == TIM4_IRQn) ? TIM4 : TIM5;
            snprintf(buffer, sizeof(buffer),
                     "UIE=%d, CC1IE=%d, CC2IE=%d",
                     (tim->DIER & TIM_DIER_UIE) != 0,
                     (tim->DIER & TIM_DIER_CC1IE) != 0,
                     (tim->DIER & TIM_DIER_CC2IE) != 0);
            break;
        }
        case I2C1_EV_IRQn: case I2C2_EV_IRQn: case I2C3_EV_IRQn: {
            I2C_TypeDef* i2c = (irq_num == I2C1_EV_IRQn) ? I2C1 :
                               (irq_num == I2C2_EV_IRQn) ? I2C2 : I2C3;
            snprintf(buffer, sizeof(buffer),
                     "ITBUFEN=%d, ITEVTEN=%d, ADDR=%d, STOPF=%d, RXNE=%d, TXE=%d",
                     (i2c->CR2 & I2C_CR2_ITBUFEN) != 0,   // Buffer interrupt enable (TXE/RXNE)
        ...
        case I2C1_ER_IRQn: case I2C2_ER_IRQn: case I2C3_ER_IRQn: {
            I2C_TypeDef* i2c = (irq_num == I2C1_ER_IRQn) ? I2C1 :
                               (irq_num == I2C2_ER_IRQn) ? I2C2 : I2C3;
            snprintf(buffer, sizeof(buffer),
                     "BERR=%d, ARLO=%d, AF=%d, OVR=%d",
        ...
        case SDIO_IRQn: {
            snprintf(buffer, sizeof(buffer),
                     "CMDRENDIE=%d, CMDSENTIE=%d, DATAENDIE=%d, RXOVERRIE=%d, TXUNDERRIE=%d, STBITERRIE=%d",
        ...
        case TAMP_STAMP_IRQn: {
            snprintf(buffer, sizeof(buffer),
                     ...
                     (RTC->TAFCR & RTC_TAFCR_TAMPIE) != 0,       // General Tamper interrupt enable
        ...
        case RCC_IRQn: {
            snprintf(buffer, sizeof(buffer),
                     ...
                     (RCC->CIR & RCC_CIR_CSSC) != 0,       // Clock Security System interrupt enable
        ...
        case ADC_IRQn: {
            snprintf(buffer, sizeof(buffer),
                     "EOCIE=%d, JEOCIE=%d, AWDIE=%d, OVRIE=%d",
                     (ADC1->CR1 & ADC_CR1_EOCIE) != 0,     // End of Conversion interrupt enable
                     (ADC1->CR1 & ADC_CR1_JEOCIE) != 0,    // Injected End of Conversion interrupt enable
